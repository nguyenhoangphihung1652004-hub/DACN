      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
        <div className="space-y-8 lg:col-span-8">
          ...
          <div className="flex flex-col rounded-[2.5rem] border border-slate-100 bg-white p-10 shadow-sm">
            ...
            <div className="relative flex-1 space-y-6 before:absolute before:top-2 before:bottom-2 before:left-2.75 before:w-0.5 before:bg-slate-50">
            ...
            {totalPages > 1 && (
              <div className="mt-5 flex items-center justify-between border-t border-slate-50">
