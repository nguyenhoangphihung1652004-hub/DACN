    ...
    >
      ...
      <div className="mt-auto border-t border-slate-50 pt-6">
        ...
        >
          ...
          <p
            className={`text-primary relative z-10 text-[10px] font-black tracking-widest whitespace-nowrap uppercase transition-all duration-300 ${
              isOpen ? 'mb-3 opacity-100' : 'mb-0 h-0 overflow-hidden opacity-0'
            }`}
          >
            Quick Action
          </p>
          ...
          >
            ...
            <span
              className={`text-xs font-black tracking-[0.15em] whitespace-nowrap uppercase transition-all duration-300 ${
                isOpen ? 'w-auto opacity-100' : 'w-0 overflow-hidden opacity-0'
              }`}
            >
              Bắt đầu học
